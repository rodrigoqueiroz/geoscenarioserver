...
```bash
pip install https://github.com/rodrigoqueiroz/geoscenarioserver/releases/download/v0.1.3/geoscenarioserver-0.1.3-py3-none-any.whl
```
...
options:
  ...
  -os, --overlay-osm    Overlay OSM background in plots
```
