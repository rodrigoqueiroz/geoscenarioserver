...
from geoscenarioserver.TrafficLight import TrafficLight
from geoscenarioserver.requirements import RequirementsChecker
from geoscenarioserver.Actor import ActorSimState

try:
    from geoscenarioserver.shm.CarlaSync import *
except:
