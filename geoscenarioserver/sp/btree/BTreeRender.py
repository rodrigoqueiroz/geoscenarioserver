...
from geoscenarioserver.sp.btree.BTreeLeaves import BCondition, ManeuverAction
...
def generate_string_tree(tree, pid, current_mconfig, show_status = True, hide_unvisited = False):
    ...
    return "Behavior Tree. Pedestrian " + str(pid) + "\n" + tree_string

def generate_graph_tree(tree, pid, current_mconfig = None, show_status = False, hide_unvisited = False):
    ...
    #Output File
    filename = "btreegraph_pid"+ str(pid) + ".png"
