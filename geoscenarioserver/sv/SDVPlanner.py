...
from geoscenarioserver.requirements.RequirementsChecker import RequirementsChecker
from geoscenarioserver.requirements.RequirementViolationEvents import AgentTick, ScenarioCompletion, ScenarioInterrupted, ScenarioEnd
from geoscenarioserver.SimTraffic import *
from geoscenarioserver.sv.maneuvers.FrenetTrajectory import *
from geoscenarioserver.sv.maneuvers.Config import *
from geoscenarioserver.sv.maneuvers.Models import plan_maneuver
from geoscenarioserver.sv.SDVTrafficState import *
...
import geoscenarioserver.sv.planners.btree.BehaviorLayer       as btree
import geoscenarioserver.sv.planners.ruleEngine.BehaviorLayer  as rules
...
class SVPlanner(object):
    ...
    def run_planner_process(self, traffic_state_sharr, mplan_sharr, debug_shdata):
        ...
        signal.signal(signal.SIGTERM, self.before_exit)
