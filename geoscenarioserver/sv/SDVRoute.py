from geoscenarioserver.Actor import TrajNode
...
from geoscenarioserver.mapping.LaneletMap import LaneletMap, get_line_format

from geoscenarioserver.SimConfig import SimConfig, POINTS_PER_METER, PLOT_VEHICLE_ROUTES
...
class SDVPath(object):
    ...
    def _set_global_path(self):
        ...
        num_points = floor(POINTS_PER_METER * centerline_length)
