# Vendored from https://github.com/yshavit/antlr-denter
# Copyright (c) 2014 Yuval Shavit
# Released under MIT License
#
# Python-like indentation token helper for ANTLR4.
# Handles conversion of newlines and indentation into INDENT/DEDENT tokens.
