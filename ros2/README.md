...
To build a single `geoscenario-ros2` conda package containing all ROS2 nodes (msgs, server, client, bringup):
...
The package is output to `ros2/dist/geoscenario-ros2-*.conda`.
