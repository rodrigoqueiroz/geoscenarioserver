...
class BTreeModel(object):
    ...
    def drive_tree(self, planner_state, **kwargs):
        ...
        is_following, leading_vid = is_in_following_range(
            self.vid, planner_state.vehicle_state, planner_state.traffic_vehicles, planner_state.lane_config)
        if is_following:
    ...
    def lanechange_scenario_tree(self, planner_state):
        ...
        elif lane_swerve_or_cutin_completed(
                planner_state.vehicle_state, planner_state.lane_config, self.mconfig, planner_state.traffic_vehicles):
            self.tree_args = {}
            self.tree = self.drive_tree
